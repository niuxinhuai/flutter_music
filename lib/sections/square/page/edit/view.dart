...
Widget buildView(
  ...
  return Scaffold(
    appBar: GpAppBar(title: Text("所有歌单"), elevation: 0),
        ...
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap:
                  () => dispatch(
                    SquareEditActionCreator.didTapEditButtonAction(),
                  ),
              child: Container(
...
Widget _buildGridView(
  ...
  return GridView.builder(
    ...
    itemBuilder: (BuildContext context, int index) {
      ...
      return _buildItemWidget(state, dispatch, viewService, sectionModel, item);
    },
  );
}

Widget _buildReoderableView(
  SquareEditState state,
  Dispatch dispatch,
  ViewService viewService,
  CatlistSectionModel sectionModel,
